...
var Yl = (c, l, b) => l in c ? ul(c, l, { enumerable: true, configurable: true, writable: true, value: b }) : c[l] = b;
var F = (c, l, b) => (Yl(c, typeof l != "symbol" ? l + "" : l, b), b);
var g = (c, l, b) => {
  if (!l.has(c))
    throw TypeError("Cannot " + b);
};
var W = (c, l, b) => (g(c, l, "read from private field"), b ? b.call(c) : l.get(c));
var Y = (c, l, b) => {
  if (l.has(c))
    throw TypeError("Cannot add the same private member more than once");
  l instanceof WeakSet ? l.add(c) : l.set(c, b);
};
var i = (c, l, b, d) => (g(c, l, "write to private field"), d ? d.call(c, b) : l.set(c, b), b);
var o = (c, l, b, d) => ({
  set _(X) {
    i(c, l, X, b);
  },
...
var v = (c, l, b) => (g(c, l, "access private method"), b);
function Jl(c) {
...
var yl = (c) => JSON.parse(JSON.stringify(c));
var Zl = class {
  /**
...
var al = (c) => {
  let l = false, b = c.slice(c.startsWith("#") ? 1 : 0);
  b.length === 3 ? b = [...b].map((X) => X + X).join("") : b.length === 8 && (l = true), b = parseInt(b, 16);
  let d = {
    r: b >>> 16,
    g: (b & 65280) >>> 8,
    b: b & 255
...
var vl = class {
  constructor(l = {}) {
    ...
    this.config = { ...sl, ...G }, this.onBeforeRoll = l.onBeforeRoll || this.noop, this.onDieComplete = l.onDieComplete || this.noop, this.onRollComplete = l.onRollComplete || this.noop, this.onRemoveComplete = l.onRemoveComplete || this.noop, this.onThemeLoaded = l.onThemeLoaded || this.noop, this.onThemeConfigLoaded = l.onThemeConfigLoaded || this.noop, nl() ? (this.canvas = Jl({
      ...
      id: this.config.id
    }), this.isVisible = true) : i(this, y, false), this.loadThemeQueue = hl();
  }
  resizeWorld() {
    const b = pl(() => {
  ...
  hide(l) {
    return l ? (this.canvas.dataset.hideClass = l, this.canvas.classList.add(l)) : this.canvas.style.display = "none", this.isVisible = false, this;
  }
  show() {
    var b;
    const l = (b = this.canvas.dataset) == null ? void 0 : b.hideClass;
    return l ? (delete this.canvas.dataset.hideClass, this.canvas.classList.remove(l)) : this.canvas.style.display = "block", this.isVisible = true, this.resizeWorld(), this;
  }
  // TODO: pass data with roll - such as roll name. Passed back at the end in the results
  roll(l, { theme: b = this.config.theme, themeColor: d = this.config.themeColor, newStartPoint: X = true } = {}) {
    this.clear();
    const Z = o(this, f)._++;
  ...
  add(l, { theme: b = this.config.theme, themeColor: d = this.config.themeColor, newStartPoint: X = true } = {}) {
    const Z = o(this, f)._++;
    this.rollCollectionData[Z] = new M({
      id: Z,
      notation: l,
  ...
  reroll(l, { remove: b = false, hide: d = false, newStartPoint: X = true } = {}) {
    const m = (Array.isArray(l) ? l : [l]).map(({ value: V, ...G }) => G);
    return b === true && this.remove(m, { hide: d }), this.add(m, { newStartPoint: X });
  }
  remove(l, { hide: b = false } = {}) {
...
f = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), C = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), u = /* @__PURE__ */ new WeakMap(), w = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), p = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), y = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakSet(), cl = async function() {
  ...
  if (W(this, y))
    if ("OffscreenCanvas" in window && "transferControlToOffscreen" in this.canvas && this.config.offscreen) {
      const b = await import("./world.offscreen-C53M2XYW.js").then((d) => d.default);
      i(this, u, new b({
        canvas: this.canvas,
        options: this.config,
        onInitComplete: l
      ...
      const b = await import("./world.onscreen-2AOID3KZ.js").then((d) => d.default);
      i(this, u, new b({
        canvas: this.canvas,
        options: this.config,
        onInitComplete: l
    ...
    const b = await import("./world.none-W3PB5MFK.js").then((d) => d.default);
    i(this, u, new b({
      canvas: this.canvas,
      options: this.config,
      onInitComplete: l
...
}, E = /* @__PURE__ */ new WeakSet(), Gl = function() {
...
}, T = /* @__PURE__ */ new WeakSet(), Wl = function() {
  const l = new MessageChannel();
  W(this, u).connect(l.port1), W(this, p).postMessage({
    action: "connect"
  }, [l.port2]);
}, Q = /* @__PURE__ */ new WeakSet(), D = async function(l, b) {
  this.onBeforeRoll(l);
...
}, P = /* @__PURE__ */ new WeakSet(), r = function(l) {
...
//# sourceMappingURL=chunk-CIAFOLQT.js.map
